...
function maintenance_mode_settings() {
  ...
  <div class="wrap">
    ...
    <?php } ?>
    <p><b>Current status: <?php echo $current_status; ?></b></p>
    <form method="post" action="">
      ...
      <p></p>
      <p>
        <a href="#" id="advanced-options-link"><?php echo $advanced_options_link_text; ?></a>
      </p>
      ...
      <p></p>
      <input type="hidden" name="show_advanced_options" id="show_advanced_options" value="<?php echo $show_secret_phrase_field ? 'true' : 'false'; ?>">
      <p>
