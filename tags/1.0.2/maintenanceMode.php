    ...
    <form method="post" action="">
      ...
      <div id="advanced-options-fields"<?php if (!$show_secret_phrase_field) { ?> style="display: none;"<?php } ?>>
        <label for="maintenance_mode_secret_phrase">
          ...
          <br>
          <span class="description"><i>Optional</i>. Show your site to people without an account. <br>Place '?[SECRET WORD]' after any URL to bypass the maintenance mode for a week. Leave blank to disable the feature.</span>
        </label>
      </div>
      <p></p>
